...
BackupPC-3.2.1.tar.gz, run these commands as root:
...
available, eg: BackupPC-3.2.1pl2.diff, you should apply
...
together with some help from Ralph Paﬂgang.
