...
$recipient = "rhstone@wakarusariver.com"; // youremail@domain.com
...
// reside on.
$referers = array('mum.myattendance.us');
...
if (file_exists($ar_file)) {
   ...
   mail_it($ar_message, isset($_POST['ar_subject'])?stripslashes($_POST['ar_subject']):"RE: Form Submission", ($ar_from)?$ar_from:$recipient, $email);
}
...
/* if ($redirect) {
   ...
   echo "<br><br>\n";
   echo "<small>Return to the <a href=\"http://mum.myattendance.us/admin.php\">Admin Home Page</a></small>\n\n";
   exit;
}
