...
$url="http://mum.myattendance.us/delete_users.php";
...
<br /><br /><input type="submit" value="Delete Selected users" >
...
echo "<tr>";
echo "<td><input type='checkbox' name='chk[]' value='$row[serialNumber]' /><br /></td>";
$c=$l;
