...
function scanUser(){
	...
	$.ajax({
		...
		success:function(data){
			...
			if( jsonObj.scanData != "Please scan your barcode" && jsonObj.scanData != "Invalid username or barcode" && jsonObj.scanData != "Invalid Barcode" )
			{
...
?>
  ...
  <!--form action="<?php //echo $_SERVER['PHP_SELF']; ?>" method="post" name="f1"-->
    <table style="width: 978px; height: 50px;" border="0" cellpadding="3" cellspacing="1" align="left">
      <tbody>
        <tr>
          <td><input type="text" maxlength="40" size="16" name="user" id="userTB" style="background-color: white; border: medium none; color: white;"></td></tr>
